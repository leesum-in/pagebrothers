interface GallerySliderLayoutHeightProps {
  className?: string;
}

function GallerySliderLayoutHeight({ className }: GallerySliderLayoutHeightProps) {
  return (
    <svg
      width="48"
      height="24"
...
export default GallerySliderLayoutHeight;

...
const config: Omit<Config, 'content'> = {
  theme: {
    ...
    backgroundImage: {
      ...
      'gradient-white-bot2top': 'linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 100%)',
      'gradient-slate-bot2top': 'linear-gradient(180deg, rgba(248, 250, 252, 0) 0%, #F8FAFC 100%)',
    },
    screens: {
      desktop: '820px',
    },
